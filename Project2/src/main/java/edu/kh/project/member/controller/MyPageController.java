...
//    (ex. 22번째 @GetMapping("/member/myPage/info") -> @GetMapping("/info")
...
public class MyPageController {
	...
	public String updateInfo(Member inputMember, String[] memberAddress,
		...
		// inputMember : memberNickname / memberTel / memberAddress(가공 필요)
	...
	// 회원 탈퇴
	@PostMapping("/delete")
	public String delete(@SessionAttribute("loginMember") Member loginMember, String memberPw, SessionStatus status,
