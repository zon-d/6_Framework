    ...
    <main>
        ...
        <section class="signUp-content">
            ...
            <form action="/member/signUp" method="POST" name="signUp-frm" id="signUp-frm">
                ...
                <div class="signUp-input-area">
                    <input type="text" name="emailCheck" id="emailCheck" placeholder="인증번호" maxlength="6"
                        autocomplete="off" required> <!-- required = 필수입력 -->
                ...
                <div class="signUp-input-area">
                    <input type="text" name="memberNickname" id="memberNickname" placeholder="닉네임" maxlength="20"
