				...
				<c:choose>
					...
					<c:when test="${empty sessionScope.loginMember}">
						...
						--%>
							...
							<fieldset id="id-pw-area">
								<section>
									<input type="text" name="memberEmail" id="memberEmail"placeholder="이메일" autocomplete="off" value="${cookie.saveId.value}">
									<%-- 쿠키 중 saveId에 저장된 값 --%>
							...
							<!-- label 태그 내부에 input태그 작성하면 자동 연결됨 -->
							<label> <input type="checkbox" id="saveId" name="saveId" ${temp}> 아이디 저장
							</label>

							<!-- 회원가입/ ID / PW 찾기 -->
							<article id="signUp-find-area">
								<a href="/member/signUp">회원가입</a> <span>|</span> <a href="#">ID/PW찾기</a>
							</article>
						</form>
					</c:when>
					...
					<c:otherwise>
						...
						<article class="login-area">
							...
							<div class="my-info">
								<div>
									<a href="/member/myPage/info" id="nickname">${loginMember.memberNickname}</a> <a href="/member/logout" id="logout-btn">로그아웃</a>
								</div>
